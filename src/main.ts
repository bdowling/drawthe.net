...
import { draw } from './js/dld4e-draw';
import { drawGridLines } from './js/dld4e-gridlines';
import { drawGroups } from './js/dld4e-groups';
import { drawIcons } from './js/dld4e-icons';
import { drawTitle } from './js/dld4e-title';
...
fonts['cisco'] = require("./js/cisco");
fonts['azure-cloud'] = require("./js/azure-cloud");
fonts['azure-enterprise'] = require("./js/azure-enterprise");

// require("./js/app");
import { saveSvgAsPng } from './js/saveSvgAsPng';
